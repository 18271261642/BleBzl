...
import com.ble.blebzl.w30s.ble.w30.W30S_AlarmInfo;
import com.ble.blebzl.w30s.ble.w30.W30S_SleepData;
...
public class W37DataAnalysis {
    ...
    //开始拍照的指令
    public static final String W37_CAMERA_TAKE_PHOTO = "com.android.phonemsg.w30s.ble.take_photo";
    //退出拍照的指令
    ...
    private void analysSleepData(byte[] data, CallDatasBackListenter callDatasBackListenter) {
        ...
        String sleep_date = "";
        List<W30S_SleepData> w30SSleepDataList = new ArrayList<>();
