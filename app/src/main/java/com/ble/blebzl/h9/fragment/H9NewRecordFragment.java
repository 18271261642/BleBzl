package com.ble.blebzl.h9.fragment;
...
import com.ble.blebzl.h9.settingactivity.CorrectionTimeActivity;
import com.ble.blebzl.h9.settingactivity.H9HearteTestActivity;
import com.ble.blebzl.h9.settingactivity.SharePosterActivity;
import com.ble.blebzl.h9.utils.Device_Time_Activity;
...
//            int h9_step_gaol = (int) SharedPreferencesUtils.getParam(MyApp.getInstance(), "H9_STEP_GAOL", 10000);
    ...
    private void regeditReceiver() {
        ...
        intFilter.addAction("com.android.phonemsg.h9.connstate");
