package com.ble.blebzl.b31.bpoxy.util;
...
import com.ble.blebzl.b31.bpoxy.markview.SPMarkerView;
...
public class VpSpo2hUtil {
    ...
    private void initMarkView(Context context, int layoutId) {
        mMarkviewSpo2h = new SPMarkerView(context, layoutId, mModelIs24, Constants.CHART_MIDDLE_SPO2H, TYPE_SPO2H);
        mMarkviewHeart = new SPMarkerView(context, layoutId, mModelIs24, Constants.CHART_MIDDLE_HEART, TYPE_HEART);
        mMarkviewSleep = new SPMarkerView(context, layoutId, mModelIs24, Constants.CHART_MIDDLE_SLEEP, TYPE_SLEEP);
        mMarkviewBeath = new SPMarkerView(context, layoutId, mModelIs24, Constants.CHART_MIDDLE_BREATH, TYPE_BREATH);
        mMarkviewLowspo2h = new SPMarkerView(context, layoutId, mModelIs24, Constants.CHART_MIDDLE_LOWSPO2H, TYPE_LOWSPO2H);
        initSpo2hChatUitl();
    }

    private void initSpo2hChatUitl() {
        String strNoData = "No data";
        mChartUtilSpo2h = new ChartViewUtil(mChartViewSpo2h, mMarkviewSpo2h, mModelIs24, Constants.CHART_MAX_SPO2H, Constants.CHART_MIN_SPO2H, strNoData, TYPE_SPO2H);
        mChartUtilHeart = new ChartViewUtil(mChartViewHeart, mMarkviewHeart, mModelIs24, Constants.CHART_MAX_HEART, Constants.CHART_MIN_HEART, strNoData, TYPE_HEART);
        mChartUtilSleep = new ChartViewUtil(mChartViewSleep, mMarkviewSleep, mModelIs24, Constants.CHART_MAX_SLEEP, Constants.CHART_MIN_SLEEP, strNoData, TYPE_SLEEP);
        mChartUtilBreath = new ChartViewUtil(mChartViewBreath, mMarkviewBeath, mModelIs24, Constants.CHART_MAX_BREATH, Constants.CHART_MIN_BREATH, strNoData, TYPE_BREATH);
        mChartUtilLowspo2h = new ChartViewUtil(mChartViewLowspo2h, mMarkviewLowspo2h, mModelIs24, Constants.CHART_MAX_LOWSPO2H, Constants.CHART_MIN_LOWSPO2H, strNoData, TYPE_LOWSPO2H);
    }
