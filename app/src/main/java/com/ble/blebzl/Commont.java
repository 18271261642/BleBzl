...
public class Commont {
    ...
    public static final String SOS_SENDSMS_MESSAGE = "com.android.phonemsg.sos.SENDSMS_MESSAGE";
    public static final String SOS_SENDSMS_LOCATION = "com.android.phonemsg.sos.SENDSMS_LOCATION";
