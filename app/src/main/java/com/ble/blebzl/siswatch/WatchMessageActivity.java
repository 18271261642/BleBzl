...
import com.ble.blebzl.bean.MessageEvent;
import com.ble.blebzl.siswatch.utils.WatchUtils;
import com.ble.blebzl.siswatch.utils.test.JiedianListener;
...
//                }
                ...
                watchmsgSwitch.setChecked(b);
                SharedPreferencesUtils.saveObject(WatchMessageActivity.this, "msg", b?"0":"1");
