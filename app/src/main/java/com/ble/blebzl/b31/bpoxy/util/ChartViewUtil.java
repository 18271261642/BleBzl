...
public class ChartViewUtil {
    ...
    private void addLimmitLines(ESpo2hDataType tag) {
        switch (tag) {
            case TYPE_SPO2H:
                addLimmitLine(new int[]{88, 91, 94, 97, (int) Constants.CHART_MAX_SPO2H}, TYPE_SPO2H, 5);
                break;
            case TYPE_HEART:
                addLimmitLine(new int[]{0, 20, 40, (int) Constants.CHART_MAX_HEART}, TYPE_HEART, 8);
                break;
            case TYPE_SLEEP:
                addLimmitLine(new int[]{0, 20, 50, (int) Constants.CHART_MAX_SLEEP}, TYPE_SLEEP, 9);
                break;
            case TYPE_BREATH:
                addLimmitLine(new int[]{0, 26, (int) Constants.CHART_MAX_BREATH}, TYPE_BREATH, 3);
                break;
            case TYPE_LOWSPO2H:
                addLimmitLine(new int[]{0, 100, (int) Constants.CHART_MAX_LOWSPO2H}, TYPE_LOWSPO2H, 4);
                break;
            case TYPE_HRV:
                addLimmitLine(new int[]{0, 110, 210, Constants.CHART_MAX_HRV}, TYPE_HRV, 22);
                break;
        }
    }
