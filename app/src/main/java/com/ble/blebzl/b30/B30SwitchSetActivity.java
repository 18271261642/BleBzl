...
public class B30SwitchSetActivity extends WatchBaseActivity {
    ...
    private void setCheckStatus() {
        ...
        EFunctionStatus isFindePhoneFunction ;//控制查找手机UI
        EFunctionStatus isStopwatch ;////秒表
        ...
        //查找手机
        if (isFindPhone) {
            isFindePhoneFunction = EFunctionStatus.SUPPORT_OPEN;
        } else {
            isFindePhoneFunction = EFunctionStatus.SUPPORT_CLOSE;
        }
        ...
        CustomSetting customSetting = new CustomSetting(true, isSystem, is24Hour, isAutomaticHeart,
                isAutomaticBoold, EFunctionStatus.UNSUPPORT, EFunctionStatus.UNSUPPORT, isFindePhoneFunction, isStopwatch, EFunctionStatus.UNSUPPORT,
