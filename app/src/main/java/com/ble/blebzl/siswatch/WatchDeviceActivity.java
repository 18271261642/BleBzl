...
import com.ble.blebzl.siswatch.bleus.GetH8JiedianListener;
import com.ble.blebzl.siswatch.bleus.ParentH8TimeListener;
import com.ble.blebzl.siswatch.bleus.SetH8JiedianListener;
import com.ble.blebzl.siswatch.h8.H8AlarmActivity;
        ...
        switch (buttonView.getId()) {
            ...
            case R.id.watch_message_callphoneSwitch:    //来电提醒
                if (!watchMessageCallphoneSwitch.isPressed())
                    return;
                AndPermission.with(WatchDeviceActivity.this).runtime().permission(Manifest.permission.READ_PHONE_STATE).start();
                watchMessageCallphoneSwitch.setChecked(isChecked);
