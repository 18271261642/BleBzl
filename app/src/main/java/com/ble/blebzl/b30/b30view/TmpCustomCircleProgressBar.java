package com.ble.blebzl.b30.b30view;
...
public class TmpCustomCircleProgressBar extends View {
    ...
    public TmpCustomCircleProgressBar(Context context) {
        this(context, null);
    }

    public TmpCustomCircleProgressBar(Context context, AttributeSet attrs) {
    ...
    public TmpCustomCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void startAnim(float startProgress,int dur) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                TmpCustomCircleProgressBar.this.progress = (float) animation.getAnimatedValue();
                postInvalidate();
            }
        });
