...
import com.ble.blebzl.activity.wylactivity.wyl_util.service.AlertService;
import com.ble.blebzl.activity.wylactivity.wyl_util.service.NewSmsBroadCastReceiver;
import com.ble.blebzl.b18.B18BleConnManager;
import com.ble.blebzl.b30.service.B30ConnStateService;
import com.ble.blebzl.b30.service.B30DataServer;
import com.ble.blebzl.bleutil.MyCommandManager;
import com.ble.blebzl.bzlmaps.PhoneSosOrDisPhone;
import com.ble.blebzl.db.DBManager;
import com.ble.blebzl.siswatch.bleus.H8BleManagerInstance;
import com.ble.blebzl.siswatch.utils.HidUtil;
...
public class MyApp extends LitePalApplication {
    ...
    public static final String RefreshBroad = "com.android.phonemsg.RefreshBroad";
...
//        });
    ...
    private void setDatabase() {
        ...
        mHelper = new DaoMaster.DevOpenHelper(this, "race_notes-db", null);
    ...
    public void startW37Server(){
        Intent intent = new Intent(this,W37ConnStatusService.class);
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            try {
                if(service != null){
                    ...
                    w37ConnStatusService = ((W37ConnStatusService.W37LoadBuilder) service).getW37ConSerevice();
                }
            }catch (Exception e){
                e.printStackTrace();
            }
