package com.ble.blebzl.siswatch;
...
import com.ble.blebzl.activity.UnPairDeviceActivity;
...
import com.ble.blebzl.siswatch.adapter.CustomBlueAdapter;
import com.ble.blebzl.siswatch.bean.CustomBlueDevice;
...
public class NewSearchActivity extends GetUserInfoActivity implements CustomBlueAdapter.OnSearchOnBindClickListener,
    ...
    private String H9CONNECT_STATE_ACTION = "com.android.phonemsg.h9.connstate";
...
//                                bluetoothAdapter.stopLeScan(leScanCallback);
            ...
            if(bleName.contains("B18") || bleName.contains("B50") || bleName.contains("B16")){
                //b18
...
//                                    Log.e(TAG, "-----22-----");
                ...
                //H9链接成功失败监听
                if (action.equals("com.android.phonemsg.h9.connstate")) {
