...
import com.ble.blebzl.xwatch.ble.XWatchNotiBean;
import com.ble.blebzl.xwatch.ble.XWatchNotiListener;
...
public class XWatchMsgAlertFragment extends LazyFragment {
    ...
    private void requestPermiss(String ... permis){
        AndPermission.with(XWatchMsgAlertFragment.this).runtime().permission(permis).start();
    }
}
