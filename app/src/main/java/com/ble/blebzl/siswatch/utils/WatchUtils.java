...
import com.ble.blebzl.activity.wylactivity.wyl_util.ScreenShot;
import com.ble.blebzl.bean.UserInfoBean;
import com.ble.blebzl.util.Common;
import com.ble.blebzl.util.MyLogUtil;
...
public class WatchUtils {
    ...
    public static final String WATCH_CONNECTED_STATE_ACTION = "com.android.phonemsg.siswatch.alarm.connectstate";  //判断蓝牙是否连接的广播action
    public static final String WATCH_GETWATCH_STEPS_ACTION = "com.android.phonemsg.siswatch.alarm.steps";   //步数的广播action
    public static final String WATCH_OPENTAKE_PHOTO_ACTION = "com.android.phonemsg.siswatch.takephoto";     //拍照指令的action
    public static final String WACTH_DISCONNECT_BLE_ACTION = "com.android.phonemsg.siswatch.bledisconnect";    //断开连接成功的action

    public static final String B30_CONNECTED_ACTION = "com.android.phonemsg.b30.connected"; //已经连接
    public static final String B30_DISCONNECTED_ACTION = "com.android.phonemsg.b30.disconnected";  //断开连接

    public static final String B31_CONNECTED_ACTION = "com.android.phonemsg.b31.connected"; //B31设备已经连接

    //B31HRV的数据读取完了，
    public static final String B31_HRV_COMPLETE = "com.android.phonemsg.b31.hrv_complete";
    //B31血氧的数据读取完了
    public static final String B31_SPO2_COMPLETE = "com.android.phonemsg.b31.spo2_complete";


    //B18连接成功了
    public static final String B18_CONNECTED_ACTION = "com.android.phonemsg.b18.conn";
    //B18断开连接
    public static final String B18_DISCONN_ACTION = "com.android.phonemsg.b18.disconn";
    //更新页面数据
    public static final String B18_UPDATE_HOME_DATA = "com.android.phonemsg.b18.update";
...
//            stepLong = (height *13)/(28*100);
    ...
    public static IntentFilter regeditAlarmBraod() {
        ...
        intentFilter.addAction("com.android.phonemsg.siswatch.alarm");
        return intentFilter;
    }
