...
import com.ble.blebzl.w30s.bean.UpDataBean;
...
//    private UpdateManager updateManager = null;
//    private int upDataState = 0x00;
//    private String FileStringPath = Environment.getExternalStorageDirectory().getPath() + "/Android/com.android.phonemsg/cache/B25_DEV.bin";
//    private String FileStringPath2 = Environment.getExternalStorageDirectory().getPath() + "/Android/com.android.phonemsg/cache/";
//    private boolean isUping = false;//是否正在升级中
//
//    @Override
//    protected void onCreate(@Nullable Bundle savedInstanceState) {
...
//        if (!isUping) {
//            if (bleName.equals("B25")) {
//                FileStringPath = Environment.getExternalStorageDirectory().getPath() + "/Android/com.android.phonemsg/cache/B25_DEV.bin";
//                typeName = "B25";
//                clientType = "B25_OTA";
//                //获取版本失败，重新获取
//                getNetWorke(typeName, clientType);
//
//            } else if (bleName.equals("B15P")) {
//                FileStringPath = Environment.getExternalStorageDirectory().getPath() + "/Android/com.android.phonemsg/cache/B15P_DEV.bin";
//                typeName = "B15P";
//                clientType = "B15P_OTA";
//                //获取版本失败，重新获取
//                getNetWorke(typeName, clientType);
