...
import com.ble.blebzl.h9.fragment.H9MineFragment;
import com.ble.blebzl.h9.fragment.H9NewDataFragment;
import com.ble.blebzl.h9.fragment.H9NewRecordFragment;
import com.ble.blebzl.h9.utils.H9ContentUtils;
...
public class H9HomeActivity extends WatchBaseActivity {
    ...
    void sendBroadcast(String type) {
        ...
        intent.setAction("com.android.phonemsg.h9.connstate");
