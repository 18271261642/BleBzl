    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.spo2BreathStopTv: //呼吸暂停
                startSpo2Desc(EnumGlossary.BREATHBREAK.getValue());
                break;
            case R.id.spo2Spo2Tv:   //血氧
                startSpo2Desc(EnumGlossary.OXGEN.getValue());
                break;
            case R.id.spo2BreathRateTv: //呼吸率
                startSpo2Desc(EnumGlossary.BREATH.getValue());
                break;
            case R.id.spo2LowO2Tv:  //低氧时间
                startSpo2Desc(EnumGlossary.LOWOXGEN.getValue());
                break;
            case R.id.spo2HeartLoadTv:  //心脏负荷
                startSpo2Desc(EnumGlossary.HEART.getValue());
                break;
            case R.id.spo2SleepActiTv:   //睡眠活动
                startSpo2Desc(EnumGlossary.SLEEP.getValue());
                break;
            case R.id.spo2LowO2ActivityTv:  //低氧唤醒
                startSpo2Desc(EnumGlossary.LOWREAMIN.getValue());
                break;
            case R.id.spo2CommTv:   //暂停呼吸常识
                startSpo2Desc(EnumGlossary.SLEEPBREATHBREAKTIP.getValue());
                break;
