...
import com.ble.blebzl.friend.bean.FrendDataBean;
import com.ble.blebzl.friend.bean.FrendMimiBean;
...
public class FrendSettingActivity extends WatchBaseActivity implements RequestView, CompoundButton.OnCheckedChangeListener {
    ...
    private Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0x01:
                    FrendMimiBean frendMimiBean = new Gson().fromJson(msg.obj.toString(), FrendMimiBean.class);
