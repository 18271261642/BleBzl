...
public class B18MessageAlertFragment extends LazyFragment {
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            switch (buttonView.getId()) {
                ...
                case R.id.b30MessageTogg:   //msg
                    //requestPermiss(Manifest.permission.READ_SMS,Manifest.permission.RECEIVE_SMS);
    ...
    private void requestPermiss(String...permissStr){
        AndPermission.with(this).runtime().permission(permissStr).start();
    }
